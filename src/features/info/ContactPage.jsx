    ...
    <div className="legal-page">
      ...
      <div className="legal-shell">
        <aside className="legal-nav">
          <div className="legal-nav-title">Empresa</div>
          <button className="legal-nav-link active">Contacto</button>
        </aside>

        <motion.article className="legal-article"
          initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>

          <div className="legal-eyebrow">FindYourBet · Empresa</div>
          <h1>Contacto</h1>
          <div className="legal-updated">¿Tienes alguna pregunta, sugerencia o problema? Escríbenos directamente por Gmail.</div>
